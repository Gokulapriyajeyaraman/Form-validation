...
function Modals({ isOpen, closeModal, handleChange, handleSubmit,formdata }) {
                ...
                <div class="relative p-4 w-full max-w-2xl max-h-full">
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <form class="p-4 md:p-5">
                            <div class="grid gap-4 mb-4 grid-cols-2">
                                <div class="col-span-2">
                                    ...
                                    <input type="text" name="name" id="name" onChange={(e) => { handleChange(e); handleNameError(e) }}
                                ...
                                <div>
                                    ...
                                    <input type="date" id="birthday" name="dateOfBirth" onChange={handleChange}
                                ...
                                <div class="col-span-2 sm:col-span-1">
                                    ...
                                    <select id="gender" name="gender" onChange={(e) => { handleChange(e); handleGenErr(e) }} class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 ">
                                ...
                                <div class="col-span-2">
                                    ...
                                    <input  name="phNo" id="phno" onChange={(e) => { handleChange(e); phNumberCheck(e); }}
                        ...
                        <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                            <button data-modal-hide="static-modal" type="button" disabled={formdata.name == ""|| formdata.dateOfBirth == "" || formdata.gender == "" || formdata.phN0 == ""}
                                class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
                                onClick={() => { closeModal(); handleSubmit(); handleClose() }}>
                                SAVE
                            </button>
                        </div>
